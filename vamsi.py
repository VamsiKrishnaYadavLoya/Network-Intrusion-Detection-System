...
X_train_1hotenc = enc.fit_transform(Xresdfcat)

# Transform test data
X_test_1hotenc = enc.fit_transform(Xtestcat)

#X_train = np.concatenate((Xresdfnum, X_train_1hotenc), axis=1)
#X_test = np.concatenate((Xtestdfnum, X_test_1hotenc), axis=1)
X_train = Xresdfnum
X_test = Xtestdfnum
